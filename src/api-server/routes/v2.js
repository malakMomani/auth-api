...
const bearer = require('../../auth-server/auth/middleware/bearer.js');
const acl = require('../../auth-server/auth/middleware/acl.js')
const basic = require('../../auth-server/auth/middleware/basic.js')
